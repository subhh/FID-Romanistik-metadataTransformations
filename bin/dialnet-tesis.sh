...
# config
codename="dialnet-tesis" # used for filename, name of OpenRefine project and value for Solr field "source"
oai_url="http://dialnet.unirioja.es/oaites/OAIHandler" # base url of OAI-PMH endpoint
